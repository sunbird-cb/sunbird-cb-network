...
public class AppStartupRunner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        NodeV2 n1 = new NodeV2("2001");
        NodeV2 n2 = new NodeV2("2002");

        NodeV2 n3 = new NodeV2("2003");
        NodeV2 n4 = new NodeV2("2004");
        NodeV2 n5 = new NodeV2("2005");
...
/*        nodeService.connect(n1, n2, relP);
        ...
        //nodeService.connect(n4, n1, relP);
...
/*
    ...
    /*    List<NodeV2> nodes=nodeService.getNodeNextLevel("2001", relP,0,10);
...
/*        List<NodeV2> allnodes=nodeService.getAllNodes("2001", relP,0,10);
